                    ...
                    <Form>
                      ...
                      <div className="rowss">
                        <div className="updating-password">
                          <Field className="input-field" name="fullnames" type="text" placeholder={fullname} />

                          {touched.fullnames && errors.fullnames ? (
                            <Erromsg style={{ paddingLeft: '10px' }}>{errors.fullnames}</Erromsg>
                          ) : (
                        ...
                        {!isSubmitting && (
                          <button type="submit" className="button-input">Update</button>
                        )}
                        <ButtonGroup>
                          {isSubmitting && (
                            <ThreeDots
                ...
                >
                  {({ isSubmitting, errors, touched }) => (
                    <Form>
                      ...
                      <div className="rowss">
                        <div className="updating-password">
                          <Field className="input-field" name="usernames" type="text" placeholder={username} />


                          {touched.usernames && errors.usernames ? (
                            <Erromsg style={{ paddingLeft: '10px' }}>{errors.usernames}</Erromsg>
                          ) : (
                            <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                          )}
                        ...
                        {!isSubmitting && (
                          <button type="submit" className="button-input" onClick={handleClick}>Update</button>
                        )}
                        <ButtonGroup>
                          {isSubmitting && (
                            <ThreeDots
                ...
                >
                  {({ isSubmitting, errors, touched }) => (
                    <Form onChange={setNewprog}>
                      ...
                      <div className="rowss">
                        <div className="updating-password">
                          <Field as='select' value={currentprog} name="programmeselect" className="input-field" type="dropdown" style={{ color: color }}>
                            {
                          ...
                          {touched.programmeselect && errors.programmeselect ? (
                            <Erromsg style={{ paddingLeft: '10px' }}>{errors.programmeselect}</Erromsg>
                          ) : (
                            <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                          )}
                        </div>
                ...
                >
                  {({ isSubmitting, errors, touched }) => (
                    <Form onChange={setNewyear}>
                      ...
                      <div className="rowss">
                        <div className="updating-password">
                          <Field as='select' value={currentyear} name="yearselect" className="input-field" type="dropdown" style={{ color: colour }}>
                            {
                          ...
                          {touched.yearselect && errors.yearselect ? (
                            <Erromsg style={{ paddingLeft: '10px' }}>{errors.yearselect}</Erromsg>
                          ) : (
                            <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                          )}
                        </div>
                    ...
                    <Form>
                      ...
                      <div className="rowss">
                        <div className="updating-password">
                          ...
                          {
                            changePassword ?
                              <Field className="input-field input-field-password" name="oldpassword" type="password" placeholder="Enter your old password" />
                              :
                              <Field className="input-field " name="old_password" type="password" placeholder="Enter your old password" />
                          }
                          {touched.oldpassword && errors.oldpassword ? (
                            <Erromsg style={{ paddingLeft: '10px' }}>{errors.oldpassword}</Erromsg>
                          ) : (
                            <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                          )}
                        ...
                        {
                          changePassword ? "" :
                            <button className="button-input" style={{ width: '100px' }} onClick={newPassword}>
                              Click to Update
                            </button>
                        }
...

                      {
                        changePassword ?
                          <>
                            ...
                            <div className="rowss">
                              <div className="updating-password">
                                <Field className="input-field input-field-password" name="newpassword" type="password" placeholder="Enter new password" />

                                {touched.newpassword && errors.newpassword ? (
                                  <Erromsg style={{ paddingLeft: '10px' }}>{errors.newpassword}</Erromsg>
                                ) : (
                                  <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                                )}
                              </div>
                            ...
                            <div className="rowss">
                              ...
                              <div className="updating-password">
                                <Field className="input-field input-field-password" name="confirmpassword" type="password" placeholder="Confirm password" />

                                {touched.confirmpassword && errors.confirmpassword ? (
                                  <Erromsg style={{ paddingLeft: '10px' }}>{errors.confirmpassword}</Erromsg>
                                ) : (
                                  <Erromsg style={{ visibility: "hidden", paddingLeft: '10px' }}></Erromsg>
                                )}
